const EXACT_TRANSLATIONS = {
    ...
    "You probably need to stack the button on top of a collection panel, if that doesnt fix it, check that all texture paths are correct": "버튼을 collection panel 위에 올려야 할 가능성이 큽니다. 그래도 안 되면 텍스처 경로가 모두 올바른지 확인해 주세요.",

...
export function getGlyphSheetHex(sheetName) {
    return sheetName.replace(/^glyph_/u, "").replace(/\.png$/iu, "").toUpperCase();
}
export function getGlyphCodepoint(sheetName, cellIndex) {
...
export function getGlyphSlotHex(cellIndex) {
    return cellIndex.toString(16).toUpperCase().padStart(2, "0");
}
//# sourceMappingURL=defaultGlyphSheets.js.map